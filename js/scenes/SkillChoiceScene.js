...
class SkillChoiceScene extends Phaser.Scene {
  ...
  create() {
    ...
    this.add.text(960, 290, 'Kattints egy kártyára, vagy nyomd meg az 1 / 2 / 3 gombot', {
  ...
  makeCard(def, i) {
    ...
    const card = this.add.rectangle(x, y, 400, 460, maxed ? 0x1a1d28 : 0x1d2335)
    ...
    this.add.text(x, y + 40, def.desc, {
      fontFamily: 'monospace', fontSize: '26px', color: textColor
    }).setOrigin(0.5);
